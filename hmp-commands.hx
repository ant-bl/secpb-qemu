...
ERST
    ...
    {
        .name       = "migrate",
        .args_type  = "detach:-d,blk:-b,inc:-i,resume:-r,uri:s,fpath:s?",
        .params     = "[-d] [-b] [-i] [-r] uri [fingerprint_path]",
        .help       = "migrate to URI (using -d to not wait for completion)"
          ...
          "\n\t\t\t [fingerprint_path] a path to a unix socket or a file to "
